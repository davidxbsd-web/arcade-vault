...
export default function AcercaDePage() {
  ...
  const [state, handleAction, pending] = useActionState(
    async (prev: ContactState, fd: FormData): Promise<ContactState> => {
      setDismissed(false);
      const result = await sendContactMessage(prev, fd);
      if (result.status === "error" && result.reason === "validation") triggerShake();
      return result;
    },
    INITIAL_STATE
  );
  ...
  const showSendError = state.status === "error" && state.reason === "send" && !dismissed;
        ...
        <div className="contact-grid">
          ...
          >
            {showSuccess ? (
              <div className="terminal-success">
                ...
                <div className="term-body">
                  ...
                  <div className="line success">
                    ...
                    {state.status === "success" ? state.name.toUpperCase() : ""}.
              ...
              <div className="terminal-success err">
                <div className="term-bar">
                  <span className="dot r"></span>
                  <span className="dot y"></span>
                  <span className="dot g"></span>
                ...
                <div className="term-body">
                  ...
                  <div className="line err">[ERROR] Conectando con servidor…</div>
                  <div className="line err">[ERROR] Transmisión interrumpida.</div>
                  <div className="line success err">
                    &gt; NO SE PUDO ENVIAR EL MENSAJE. INTENTA DE NUEVO.
                    <span className="caret">_</span>
                  </div>
                  <div style={{ marginTop: 18 }}>
                    <button className="btn ghost" type="button" onClick={() => setDismissed(true)}>
                      REINTENTAR
                    </button>
                  </div>
                </div>
